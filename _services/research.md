...
| ![MGHPCC]({{"/images/net2_logo.jpg" | relative_url }}){: width="5000" }<br>![MGHPCCLOGO]({{"/images/net2.jpg" | relative_url }}){: width="5000" } | We are building a new Tier 2 at the [Massachusetts Green High Performance Computing Center](https://www.mghpcc.org/) (MGHPCC) called the **Northeast Tier 2** [NET2 cluster](https://www.mghpcc.org/project/the-us-atlas-northeast-tier-2-center/). NET2 is a cluster with over 15,000 CPU cores and 10 PB of storge used to produce simulation and analyze data for the ATLAS experiment. It processes the ATLAS software for users all around the world to produce physics results. The opportunity to build a system from scratch gives us the freedom to implement several improvements, something that would be challenging in a deployed system. NET2 operates purely over a kubernetes virtualization layer, allowing for seamless integration with other resources at the MGHPCC and outside. NET2 is also the first US ATLAS Tier 2 cluster to use a tape system for operations, a project developed in collaboration with [NESE](https://nese.mghpcc.org/).<br><br>**Participants**: Eduardo Bach, Will Leight, Harvard U. |

## ITk Pixel Inner System

| ![ITk Pixel Inner System]({{"/images/itk.jpg" | relative_url }}){: width="5000" } | In 2029, the LHC will undergo a major upgrade (the high-luminosity LHC) and will start collecting data at a rate ten times higher. The detectors will also have to be upgraded in order to deal with the increased rate of collisions while maintaining the same physics performance. One critical upgrade is the replacement of the Inner Detector, the subsystem responsible for measuring the flight direction and decay vertices of the particles produced in the collisions, by a new silicon detector called the “Inner Tracker” (ITK). I am part of the team designing and building this new sub-detector. At UMass, we built a robotic system to automatically probe the flex circuits used in the detector. I have also done the complete thermal and cooling design of the innermost part of the ITk detector (Pixel Inner System). <br><br>**Participants**: Colin Devine, Shani Perera<br>**Collaborators**: ANL, LBNL, SLAC |
